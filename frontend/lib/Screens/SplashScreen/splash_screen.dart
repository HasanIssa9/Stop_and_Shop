    ...
    return Scaffold( 
      ...
      body: Container( 
        ...
        children: [
          ...
          AnimatedSplashScreen(splash:Align(
      ...
      backgroundColor:Color.fromRGBO(0, 128, 0, 0),
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.color = Color(0xff00821A).withOpacity(1.0);
    ...
    paint_1_fill.color = Color(0xff029D36).withOpacity(1.0);
    ...
    paint_2_fill.color = Color(0xff82CE65).withOpacity(1.0);
    ...
    paint_3_fill.color = Color(0xff6CD06B).withOpacity(1.0);
    ...
    paint_4_fill.color = Color(0xff059931).withOpacity(1.0);
    ...
    paint_5_fill.color = Color(0xff059931).withOpacity(1.0);
    ...
    paint_6_fill.color = Color(0xff059931).withOpacity(1.0);
    ...
    paint_7_fill.color = Color(0xff059931).withOpacity(1.0);
    ...
    paint_8_fill.color = Color(0xff059931).withOpacity(1.0);
    ...
    paint_9_fill.color = Color(0xff6CD06B).withOpacity(1.0);
    ...
    paint_10_fill.color = Color(0xff6CD06B).withOpacity(1.0);
    ...
    paint_11_fill.color = Color(0xff6CD06B).withOpacity(1.0);
    ...
    paint_12_fill.color = Color(0xff6CD06B).withOpacity(1.0);
